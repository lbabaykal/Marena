        ...
        return (
            (o.prototype.checkRequirements = function () {
                ...
                (o.prototype.setContainer = function () {
                    let t = document.querySelector(".notifications-container");
                ...
                (o.prototype.setWrapper = function () {
                    let t;
                    this.customWrapper ? (this.wrapper = ((t = this.customWrapper), new DOMParser().parseFromString(t, "text/html").body.childNodes[0])) : (this.wrapper = document.createElement("div")),
                ...
                (o.prototype.setContent = function () {
                    ...
                    this.title && ((t = document.createElement("div")).classList.add("notify__title"), (t.textContent = this.title), this.showCloseButton || (t.style.paddingRight = "0")),
                    this.text && ((e = document.createElement("div")).classList.add("notify__text"), (e.innerHTML = this.text.trim()), this.title || (e.style.marginTop = "0")),
